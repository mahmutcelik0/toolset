...
const SAMPLE_TEXT = `Merhaba Dünya! Bu bir SHA-1 test metnidir.
Hello World! This is an SHA-1 test text.
1234567890 !@#$%^&*()`
...
export default function Sha1Generator() {
    ...
    const [status, setStatus] = useState<Status>({
        type: "idle",
        msg: "Metin girip SHA-1 oluştur'a tıklayın"
    })
    ...
    // SHA-1 hash fonksiyonu (Web Crypto API kullanarak)
    const generateSha1 = useCallback(async (text: string): Promise<string> => {
        ...
        // Web Crypto API ile SHA-1 hash oluştur
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-4 p-3 bg-[#1a1d27] border border-white/8 rounded-lg">
                ...
                <span className="text-xs text-white/30 ml-2">SHA-1: 160-bit (40 karakter)</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="flex flex-col bg-[#1a1d27] border border-white/8 rounded-xl overflow-hidden">
                    <div className="flex items-center justify-between px-3 py-2 bg-[#22263a] border-b border-white/8 shrink-0">
                        <span className="text-xs font-medium tracking-widest text-white/30 uppercase">SHA-1 Hash</span>
            ...
            <div className="bg-[#1a1d27] border border-white/8 rounded-xl overflow-hidden">
                <div className="px-3 py-2 bg-[#22263a] border-b border-white/8">
                    <span className="text-xs font-medium tracking-widest text-white/30 uppercase">SHA-1 Bilgisi</span>
                </div>
                <div className="p-4 grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                    <div className="text-white/40">
                        ...
                        <br />SHA-1 (Secure Hash Algorithm 1)
                    </div>
                    <div className="text-white/40">
                    ...
                    <div className="text-white/40">
                        <span className="text-white/60 font-medium">⚠️ Uyarı</span>
                        <br />Kriptografik olarak güvenli değil
                    </div>
                </div>
            </div>
